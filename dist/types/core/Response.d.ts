...
export declare class DidSiopResponse {
     ...
     */
    static generateResponse(decodedRequest: any, signingInfo: JWT.SigningInfo, didSiopUser: Identity, expiresIn: number | undefined, crypto: Crypto, request: string, storage: Storage, vc?: any): Promise<string>;
    /**
     *
