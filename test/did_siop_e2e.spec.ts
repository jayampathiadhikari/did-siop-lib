...
describe('DID SIOP', function () {
    ...
    test('DID SIOP end to end functions testing (Auth Code flow)- expect truthy', async () => {
    ...
    test('DID SIOP end to end functions testing (Implicit grant flow) - expect truthy', async () => {
        jest.setTimeout(10000);
    ...
    test('DID SIOP end to end functions testing - expect falsy', async () => {
        ...
        let responsePromise = provider.generateResponse(requestObj.payload, request);
